...
fn main() {
    ...
    let mut bg = Sprite::new("bg3.png", gl::NEAREST as i32, &shader);
    ...
    let log1_unfocused = Object::Sprite(log1_unfocused);
    ...
    let log1_focused = Object::Sprite(log1_focused);
    ...
    let log2_unfocused = Object::Sprite(log2_unfocused);
    ...
    let log2_focused = Object::Sprite(log2_focused);
    ...
    let log3_unfocused = Object::Sprite(log3_unfocused);
    ...
    let log3_focused = Object::Sprite(log3_focused);

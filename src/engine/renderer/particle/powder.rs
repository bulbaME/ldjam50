...
impl <'a> Powder <'a> {
    pub fn new(
        ...
        let emmiter = emitter::Emitter {
            ...
            particle_size: Range { start: 4.0, end: 6.0 },
            particle_final_size: Range { start: 4.0, end: 6.0 },
            
            particle_lifespan: Range { start: 1000.0, end: 2000.0 },
            
            initial_count: Range { start: 100, end: 130 },
            spawn_count: Range { start: 100, end: 130 },

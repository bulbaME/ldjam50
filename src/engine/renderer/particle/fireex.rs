...
impl <'a> Fireex <'a> {
    pub fn new(
        ...
        let emmiter = emitter::Emitter {
            ...
            particle_size: Range { start: 6.0, end: 10.0 },
            particle_final_size: Range { start: 10.0, end: 13.0 },
            
            particle_lifespan: Range { start: 1000.0, end: 2000.0 },
            
            initial_count: Range { start: 100, end: 120 },
            spawn_count: Range { start: 100, end: 120 },
            
            spawn_interval: Range { start: 50.0, end: 100.0 },
            current_interval: 0.0,
            next_interval: 0.0,
            
            start_color: Range { start: Vec4 {x: 0.9, y: 0.9, z: 0.9, w: 1.0 }, end: Vec4 { x: 1.0, y: 1.0, z: 1.0, w: 1.1 } },
            ...
            final_mass: Range { start: 0.0, end: 0.0001 },
        };
